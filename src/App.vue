<template>
    <div id="app">
        <!-- <div @click="testLocalStorage()">测试清楚缓存</div> -->
        <!--  |{{myInfo}}| -->
...
export default {
    ...
    created() {
        // if (!this.myInfo.email) {
        //     console.log('>>>22222', this.myInfo)
        //     location.href = "/#/login"
        // }
    },
    watch: {
    ...
    computed: {
        ...
        //...mapState('localStorage', { info22: 'info' }),
        //...mapGetters('localStorage', { myInfo: 'getInfo' }),
    },
    methods: {
        testLocalStorage() {
            store.dispatch('localStorage/removeItem')
        },
