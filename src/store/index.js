...
export default new Vuex.Store({
    modules: {
        ...
        localStorage: {
            namespaced: true,
            /*
            created by fengjie.liu 2018.05.30
            本地存储
            */
            state: {
                //info: {},
                info: (() => {
                    ...
                    let data = JSON.parse(storage.getItem('teamUp'))
                    return data ? data : {};
                })(),
            },
            mutations: {
                removeLocal(state) {
                    ...
                    state.info = {};
                    location.href = '/login';
                    // console.log('清除本地存储', state.info)
                },
                addLocal(state, { data }) {
                    //console.log('addLocal', data)
            ...
            actions: {
                ...
                setItem({ state, commit, dispatch }, data) {
                    commit('addLocal', { data: data })
                }
            },
            getters: {
