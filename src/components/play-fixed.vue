<template>
    <div class="fixed-wrapper">
        <mt-cell class="music-cell-song-fixed">
            <router-link tag="div" class="song-cover" :to="{name: 'playing'}" @touchstart.native="swipeStart" @touchmove.native="swipeMove" @touchend.native="swipeEnd">
            ...
            <div class="play-wrapper">
                <div class="circle-wrapper">
                    <svg class="progress-circle" width="24px" height="24px" xmlns="http://www.w3.org/2000/svg">
                        <circle class="progress-circle-prog" cx="12" cy="12" r="11.1" ref="progress" :style="{strokeDasharray: playingPrgress*70+ ', 70'}"></circle>
                    </svg>
                    <img @click="pause(playingState == 'pause' ? '' : 'pause')" :src="require(`@/assets/${this.songState.playingState == 'pause' ? 'play-small':'pause'}.png`)" class="play-icon">
                </div>
