    ...
    <div class="page">
        <div class="inner-page">
            ...
            <div class="project-labels">
                <a href="javascript:;" v-for="label in projectInfo.labelList" v-if="projectInfo.labelList.length">{{label.name}}</a>
                <p v-if="projectInfo.labelList && !projectInfo.labelList.length">暂时没有关联标签</p>
            </div>
            <!-- /labels -->
            <!-- project-number -->
